export const author = {
  ...
  education: [
    ...
    {
      degree: 'M.A. in International Economics and Finance',
  ...
  social: [
    {
      icon: 'google-scholar',
      iconPack: 'ai',
      url: 'https://scholar.google.com/citations?user=gb9961AAAAAJ&hl=en&oi=ao',
    },
    {
      icon: 'orcid',
      iconPack: 'ai',
      url: 'https://orcid.org/0000-0002-4581-0125',
    },
    {
      icon: 'linkedin',
      iconPack: 'fab',
      url: 'https://www.linkedin.com/in/jiangzhenling',
    },
    {
      icon: 'envelope',
      iconPack: 'fas',
      url: 'mailto:zhenling@wharton.upenn.edu',
    },
    {
      icon: 'x-twitter',
      iconPack: 'fab',
      url: 'https://twitter.com/zhenlingj',
    },
    {
      icon: 'cv',
      iconPack: 'ai',
  ...
  contact: {
    email: 'zhenling@wharton.upenn.edu',
    phone: '(215) 898-2534',
    address: '747 Jon M. Huntsman Hall, 3730 Walnut Street, Philadelphia, PA 19104',
  },
}
